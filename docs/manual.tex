...
\begingroup \fontsize{8pt}{10pt}\selectfont \begin{alltt}
...
\begin{figure}[h!]
\centering
\centering{\includegraphics[totalheight = 0.5\textheight, trim=0cm 2.8cm 0cm 2cm, clip = true]{FullExperiment_copy.pdf}}
\end{figure}
\end{comment}
